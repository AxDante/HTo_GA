...
void popTableInitialize(){
  ...
  popTable.addColumn("fitness");
  popTable.addColumn("bestGene");
  popTable.addColumn("bestID");
 
  popTable.addColumn("costScore");
  popTable.addColumn("smoothScore");
  popTable.addColumn("safeScore");
  
  popTable.addColumn("F0");
  popTable.addColumn("F1");
