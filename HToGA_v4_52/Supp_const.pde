...
class MapDB{
  ...
  // ---------map 10---------- (larger map, X-Y map axis correction)
   ...
   // ---------map 14---------- (vertical Dynamic)
    ...
    Obss = new Obstacle[3];
    Obss[0] = new Obstacle(new PVector(5*blkWidth, 5*blkWidth), new PVector(2*blkWidth, 12*blkWidth));
    Obss[1] = new Obstacle(new PVector(17*blkWidth, 5*blkWidth), new PVector(2*blkWidth, 12*blkWidth));
