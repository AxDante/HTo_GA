  ...
  boolean isConverged() {
    ...
    if (gen-1 > minConvergeSample) {
      ...
      if (StepData[gen-1-minConvergeSample] != -1 &&
          StepData[gen-1] == StepData[gen-3] && StepData[gen-1] == StepData[gen-5] && StepDataCD[gen-1] == StepDataCD[gen-7] &&
          //StepDataCD[gen-1] == StepDataCD[gen-3] &&
          historyBestScore[gen-1] == historyBestScore[gen-10]){
        return true;
      }
    }
    return false;
