  ...
  if (intTrials < totTrials){
    ...
    if (trialComplete){
      ...
      if (intTrials < totTrials){
        ...
        float sumRG = 0, sumTG = 0, sumC = 0, sumT = 0, sumSM = 0, sumSF = 0;
        
        float avgRT = 0, avgTT = 0;
        float avgRG = 0, avgTG = 0, avgC = 0, avgT = 0, avgSM = 0, avgSF = 0;
        
        float sumDevRT = 0, sumDevTT = 0;
        float sumDevRG = 0, sumDevTG = 0, sumDevC = 0, sumDevT = 0, sumDevSM = 0, sumDevSF = 0;
        
        float stdRT = 0, stdTT = 0;
        float stdRG = 0, stdTG = 0, stdC = 0, stdT = 0, stdSM = 0, stdSF = 0;
        ...
        for(int inttr = 0; inttr < totTrials; inttr++){
          ...
          sumDevC += pow((float)trialC[inttr]- avgC, 2);
        ...
        stdC = pow(sumDevC/totTrials,0.5);
        ...
        for(int inttr = 0; inttr < totTrials; inttr++){
          ...
          println("C: " + trialC[inttr] + " | T: " + trialT[inttr] + " | SM: " + trialSM[inttr] + " | SF: "+ trialSF[inttr] );
        }
        println();
        println("avgC: " + avgC + " | avgT: " + avgT + " | avgSM: " + avgSM + " | avgSF: "+ avgSF );
        println("avgRG: " + avgRG + " | avgTG: " + avgTG + " | avgRT: "+ avgRT + " | avgTT: "+ avgTT);
        println("stdC: " + stdC + " | stdT: " + stdT + " | stdSM: " + stdSM + " | stdSF: "+ stdSF );
