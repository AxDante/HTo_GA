class MapDB{
  ...
  MapDB(){
    ...
    // ---------map 05----------
    mapSize = new PVector(500,500);
    
    gridBasedMode = true;
     
    Wps = new Waypoint[2];
    Wps[0] = new Waypoint(new PVector(16*blkWidth, 16*blkWidth), 0); 
    Wps[1] = new Waypoint(new PVector(2*blkWidth, 2*blkWidth), 0);
    
    Obss = new Obstacle[3];
    Obss[0] = new Obstacle(new PVector(5*blkWidth, 5*blkWidth), new PVector(12*blkWidth, 2*blkWidth));
    Obss[1] = new Obstacle(new PVector(10*blkWidth, 3*blkWidth), new PVector(2*blkWidth, 5*blkWidth));
    Obss[2] = new Obstacle(new PVector(5*blkWidth, 12*blkWidth), new PVector(2*blkWidth, 2*blkWidth));
  ...
  // ---------map 10---------- (larger map, X-Y map axis correction)
   ...
   // ---------map 13---------- (vertical Dynamic)
    ...
    Wps = new Waypoint[2];
    Wps[0] = new Waypoint(new PVector(11*blkWidth, 7*blkWidth), 0); 
    Wps[1] = new Waypoint(new PVector(11*blkWidth, 15*blkWidth), 0);
    
    Obss = new Obstacle[3];
    Obss[0] = new Obstacle(new PVector(5*blkWidth, 5*blkWidth), new PVector(2*blkWidth, 14*blkWidth));
    Obss[1] = new Obstacle(new PVector(17*blkWidth, 5*blkWidth), new PVector(2*blkWidth, 14*blkWidth));
    Obss[2] = new Obstacle(new PVector(5*blkWidth, 11*blkWidth), new PVector(12*blkWidth, 2*blkWidth));
    
    DyObssList = new ArrayList<DynamicObstacle>();
    Maps[13] = new Map(mapSize, gridBasedMode, Wps, Obss, DyObssList);

    // ---------map 14---------- (vertical Dynamic)
    mapSize = new PVector(600,600);  //24*24
    
    gridBasedMode = true;
     
    Wps = new Waypoint[2];
    Wps[0] = new Waypoint(new PVector(1*blkWidth, 1*blkWidth), 0); 
    //Wps[1] = new Waypoint(new PVector(20*blkWidth, 20*blkWidth), 0);
    //Wps[2] = new Waypoint(new PVector(2*blkWidth, 8*blkWidth), 0);
    Wps[1] = new Waypoint(new PVector(8*blkWidth, 14*blkWidth), 0);
    Obss = new Obstacle[5];
    Obss[0] = new Obstacle(new PVector(0*blkWidth, 4*blkWidth), new PVector(20*blkWidth, 2*blkWidth));
    Obss[1] = new Obstacle(new PVector(18*blkWidth, 4*blkWidth), new PVector(2*blkWidth, 16*blkWidth));
    Obss[2] = new Obstacle(new PVector(4*blkWidth, 18*blkWidth), new PVector(16*blkWidth, 2*blkWidth));
    Obss[3] = new Obstacle(new PVector(4*blkWidth, 10*blkWidth), new PVector(2*blkWidth, 10*blkWidth));
    Obss[4] = new Obstacle(new PVector(6*blkWidth, 10*blkWidth), new PVector(8*blkWidth, 2*blkWidth));
    
    DyObssList = new ArrayList<DynamicObstacle>();
    Maps[14] = new Map(mapSize, gridBasedMode, Wps, Obss, DyObssList);
    ...
    Wps = new Waypoint[2];
    Wps[0] = new Waypoint(new PVector(5*blkWidth, 5*blkWidth), 0); 
    //Wps[1] = new Waypoint(new PVector(18*blkWidth, 4*blkWidth), 0); 
    Wps[1] = new Waypoint(new PVector(5*blkWidth, 18*blkWidth), 0);
    
    Obss = new Obstacle[5];
    Obss[0] = new Obstacle(new PVector(11*blkWidth, 0*blkWidth), new PVector(2*blkWidth, 5*blkWidth));
    Obss[1] = new Obstacle(new PVector(11*blkWidth, 6*blkWidth), new PVector(2*blkWidth, 12*blkWidth));
    Obss[2] = new Obstacle(new PVector(11*blkWidth, 19*blkWidth), new PVector(2*blkWidth, 5*blkWidth));
    Obss[3] = new Obstacle(new PVector(0*blkWidth, 11*blkWidth), new PVector(18*blkWidth, 2*blkWidth));
    Obss[4] = new Obstacle(new PVector(19*blkWidth, 11*blkWidth), new PVector(5*blkWidth, 2*blkWidth));
    
    DyObssList = new ArrayList<DynamicObstacle>();
    Maps[15] = new Map(mapSize, gridBasedMode, Wps, Obss, DyObssList);
    ...
    Wps = new Waypoint[2];
    Wps[0] = new Waypoint(new PVector(20*blkWidth, 3*blkWidth), 0); 
    Wps[1] = new Waypoint(new PVector(3*blkWidth, 20*blkWidth), 0);
    
    Obss = new Obstacle[7];
    Obss[0] = new Obstacle(new PVector(4*blkWidth, 4*blkWidth), new PVector(3*blkWidth, 3*blkWidth));
    Obss[1] = new Obstacle(new PVector(13*blkWidth, 6*blkWidth), new PVector(6*blkWidth, 2*blkWidth));
    Obss[2] = new Obstacle(new PVector(11*blkWidth, 10*blkWidth), new PVector(2*blkWidth, 2*blkWidth));
    Obss[3] = new Obstacle(new PVector(7*blkWidth, 13*blkWidth), new PVector(2*blkWidth, 7*blkWidth));
    Obss[4] = new Obstacle(new PVector(14*blkWidth, 15*blkWidth), new PVector(3*blkWidth, 4*blkWidth));
    Obss[5] = new Obstacle(new PVector(16*blkWidth, 15*blkWidth), new PVector(5*blkWidth, 2*blkWidth));
    Obss[6] = new Obstacle(new PVector(3*blkWidth, 9*blkWidth), new PVector(3*blkWidth, 2*blkWidth));
    
    DyObssList = new ArrayList<DynamicObstacle>();
    Maps[16] = new Map(mapSize, gridBasedMode, Wps, Obss, DyObssList);
    
    
         // ---------map 17---------- (vertical Dynamic)
    ...
    Wps = new Waypoint[4];
    Wps[0] = new Waypoint(new PVector(4*blkWidth, 4*blkWidth), 0); 
    Wps[1] = new Waypoint(new PVector(4*blkWidth, 19*blkWidth), 0);
    Wps[2] = new Waypoint(new PVector(19*blkWidth, 19*blkWidth), 0);
    Wps[3] = new Waypoint(new PVector(19*blkWidth, 4*blkWidth), 0);
    
    Obss = new Obstacle[0];

    DyObssList = new ArrayList<DynamicObstacle>();
    DyObssList.add(new DynamicObstacle(new PVector(3, 10).mult(blkWidth), new PVector(18, 4).mult(blkWidth),
                                    1, 0, 25, 10));
    DyObssList.add(new DynamicObstacle(new PVector(10, 3).mult(blkWidth), new PVector(4, 18).mult(blkWidth),
                                    0, -1, 25, 10));
                                    
    Maps[17] = new Map(mapSize, gridBasedMode, Wps, Obss, DyObssList);
  
    
    // ---------map 18---------- (parallel Dynamic obstacle)
    mapSize = new PVector(600,600);
    
    gridBasedMode = true;
     
    Wps = new Waypoint[2];
    Wps[0] = new Waypoint(new PVector(11*blkWidth, 2*blkWidth), 0); 
    Wps[1] = new Waypoint(new PVector(11*blkWidth, 20*blkWidth), 0);
    
    Obss = new Obstacle[2];
    Obss[0] = new Obstacle(new PVector(0*blkWidth, 0*blkWidth), new PVector(6*blkWidth, 24*blkWidth));
    Obss[1] = new Obstacle(new PVector(18*blkWidth, 0*blkWidth), new PVector(6*blkWidth, 24*blkWidth));
    

    DyObssList = new ArrayList<DynamicObstacle>();
    
    DyObssList.add(new DynamicObstacle(new PVector(10, 6).mult(blkWidth), new PVector(10, 1).mult(blkWidth),
                                    -1, 0, 20, 5));      
                                    
    DyObssList.add(new DynamicObstacle(new PVector(4, 11).mult(blkWidth), new PVector(10, 1).mult(blkWidth),
                                    1, 0, 20, 5));         
                                    
    DyObssList.add(new DynamicObstacle(new PVector(10, 16).mult(blkWidth), new PVector(10, 1).mult(blkWidth),
                                    -1, 0, 20, 5));  
