class Population {
  ...
  void show() {
    Rbts[0].show();
    for (int i = 1; i< floor(Rbts.length/5); i++) {
      Rbts[i].show();
    }
  }
  ...
  void update() {
    ...
    for (int rbtidx = 0; rbtidx < Rbts.length; rbtidx++) {
      ...
      println("Block 2 - Position: (" + curRbt.pos.x + ", " + curRbt.pos.y + ")");
      println("Block 1 - Position: (" + curRbt.pos.x + ", " + curRbt.pos.y + ")");
      println("Block 3 - Position: (" + curRbt.pos.x + ", " + curRbt.pos.y + ")");
      println("Block 4 - Position: (" + curRbt.pos.x + ", " + curRbt.pos.y + ")");
