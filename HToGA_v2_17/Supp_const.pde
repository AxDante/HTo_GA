...
class MapDB{
  ...
  // ---------map 10---------- (larger map, X-Y map axis correction)
    ...
    Wps[1] = new Waypoint(new PVector(10, 30).mult(blkWidth), 0);
    Wps[2] = new Waypoint(new PVector(29, 30).mult(blkWidth), 0);
    Wps[3] = new Waypoint(new PVector(29, 10).mult(blkWidth), 0);
    Wps[4] = new Waypoint(new PVector(48, 10).mult(blkWidth), 0);
    Wps[5] = new Waypoint(new PVector(48, 30).mult(blkWidth), 0);
    
    Obss = new Obstacle[12];
    //VERT
    Obss[0] = new Obstacle(new PVector(0, 0).mult(blkWidth), new PVector(2, 40).mult(blkWidth));
    Obss[1] = new Obstacle(new PVector(19, 0).mult(blkWidth), new PVector(2, 30).mult(blkWidth));
    Obss[2] = new Obstacle(new PVector(19, 31).mult(blkWidth), new PVector(2, 10).mult(blkWidth));
